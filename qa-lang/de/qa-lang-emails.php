...
*/
	...
	return array(
		...
		'reset_body' => "Bitte klicke auf den folgenden Link, um dein Passwort für ^site_title zurückzusetzen:\n^url\n\nAlternativ, können Sie den untenstehenden Code in das Feld auf der Website eingeben.\n\nCode: ^code\n\nWenn Sie Ihr Passwort nicht zurücksetzen wollen, können Sie diese Email einfach ignorieren.\n\nVielen Dank,\n^site_title",
		'reset_subject' => '^site_title - Passwort zurücksetzen',
		'welcome_body' => "Danke, dass Sie dich bei ^site_title angemeldet hast.\n\n^custom^confirmIhre Login-Daten lauten:\n\nUsername: ^handle\nEmail: ^email\n\nBitte bewahre diese Informationen sicher auf.\n\nVielen Dank,\n\n^site_title\n^url",
		'welcome_confirm' => "Bitte klicke auf den folgenden Link, um Ihre Email-Adresse zu bestätigen:\n^url\n\n",
		...
		'private_message_body' => "Sie hast eine private Nachricht von ^f_handle auf ^site_title:\n\n^open^message^close erhalten.\n\n^moreVielen Dank,\n\n^site_title\n\n\nUm private Nachrichten zu sperren, loggen Sie sich bitte in Ihr Konto ein:\n^a_url",
		...
		'u_approved_body' => "Sie können Dein neues Benutzerprofil hier sehen:\n\n^url\n\nDanke,\n\n^site_title",
		'u_approved_subject' => "Dein ^site_title Benutzer wurde bestätigt",
		'wall_post_subject' => "Post auf Ihrer ^site_title Pinnwand",
		'wall_post_body' => "^f_handle hat an Ihre Pinnwand geschrieben auf ^site_title:\n\n^open^post^close\n\nSie können auf den Post hier antworten:\n\n^url\n\nDanke,\n\n^site_title",
	);
